...
export class UserView extends View {
    ...
    renderPastPurchases(pastPurchases) {
        ...
        if (!pastPurchases || pastPurchases.length === 0) {
            this.#pastPurchasesList.innerHTML = '<p>Nenhuma compra encontrada para esse cliente.</p>';
            return;
        }
    ...
    addPastPurchase(product) {
        ...
        if (this.#pastPurchasesList.innerHTML.includes('Nenhuma compra encontrada para esse cliente')) {
